...
import cn.edu.sjtu.minhao.li.kotlinchatter.ChattStore.postChatt
import cn.edu.sjtu.minhao.li.kotlinchatter.databinding.ActivityPostBinding
...
class PostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view.cameraButton.setOnClickListener{
            viewState.imageUri = mediaStoreAlloc("image/jpeg")
            fortakeresult.launch(viewState.imageUri)
        }
